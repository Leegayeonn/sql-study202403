...
-- 이미 만들어진 view의 수정 (CREATE OR REPLACE VIEW 구문)
...
-- 두번째 컬럼인 'frull_name'은 가상열(virtual column)이기 때문에 INSERT 안됨
INSERT INTO view_emp_dept_job
VALUES (300, 'test', 'test','test',10000); --안됨

-- JOIN된 view(복합뷰)의 경우에는 한번에 삽입할 수 없습니다.
INSERT INTO view_emp_dept_job
...
WITH CHECK OPTION CONSTRAINT view_emp_test_ck; -- 조건 컬럼 변경을 막아준다!
